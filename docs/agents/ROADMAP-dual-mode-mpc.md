...
## Next
Iterate **SWD-247** shipped (PR #541 — Ipopt install pass + SciPy NLP fallback; clean mode help). Story **SWD-238** remains open while research Task **SWD-239** is still To Do (optional closeout).
