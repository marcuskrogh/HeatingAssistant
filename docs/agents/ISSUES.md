...
| SWD-558 | Task | [Bug] PE optimiser floors; extra time does not deepen the fit | To Do | Relates SWD-557 | docs/agents/PLAN-pe-optimizer-stall.md | `/architect SWD-558` |
