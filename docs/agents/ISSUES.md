...
|-----|------|-------|--------|--------|----------|------|
| SWD-576 | Task | [Feature] Archive finished PE results below stored datasets | To Do | Relates SWD-573 | docs/agents/PLAN-pe-fit-results.md | `/architect SWD-576` — https://github.com/marcuskrogh/HeatingAssistant/pull/695 |
| SWD-577 | Sub-task | Persist finished PE results with exit, RMSE, and R² | To Do | SWD-576 | docs/agents/PLAN-pe-fit-results.md | — |
| SWD-578 | Sub-task | UI: identification results list, load, and delete | To Do | SWD-576 | docs/agents/PLAN-pe-fit-results.md | — |
| SWD-579 | Sub-task | Tests, CalVer, changelog, App sync for PE result archive | To Do | SWD-576 | docs/agents/PLAN-pe-fit-results.md | — |
...
| SWD-543 | Sub-task | Wire configurable NMPC max compute time through engine and Tuning | Done | SWD-542 | docs/agents/PLAN-nmpc-max-compute.md | — |
| SWD-544 | Sub-task | Tests, CalVer, changelog, App sync for NMPC compute cap | Done | SWD-542 | docs/agents/PLAN-nmpc-max-compute.md | — |
...
| SWD-525 | Sub-task | Tests, CalVer, changelog, App sync | Done | SWD-522 | docs/agents/PLAN-mpc-mode-choice.md | — |
| SWD-519 | Task | [Iterate] Compute overlay and KPIs lag after NMPC/P finish | Done | — | docs/agents/ITERATE-compute-refresh.md | Done — https://github.com/marcuskrogh/HeatingAssistant/pull/671 (`ee376de5`) |
| SWD-520 | Sub-task | Publish compute status at NMPC start/end; refresh UI on finish | Done | SWD-519 | docs/agents/ITERATE-compute-refresh.md | — |
| SWD-521 | Sub-task | Tests, CalVer, changelog, App sync for compute refresh | Done | SWD-519 | docs/agents/ITERATE-compute-refresh.md | — |
...
| SWD-497 | Task | [Sandbox] PE popup KPIs, log plot, and Jacobian check | Done | — | docs/agents/SANDBOX-pe-progress.md | Done — https://github.com/marcuskrogh/HeatingAssistant/pull/663 (`74934ce`) |
...
| SWD-485 | Sub-task | N-step harness bar, tests, CalVer | Done | SWD-481 | docs/agents/PLAN-pe-nstep-mle.md | — |
...
- 2026-09-03 — `/implement` SWD-475: promote sandbox expand motion, Description topic, NMPC Load vs Regulator Load into production. CalVer 2026.09.1. Next `/test SWD-475`.
- 2026-09-03 — `/sandbox` SWD-475 iteration 3: NMPC Load (Overview) vs Regulator Load (room), subsections, faint leaders. Next `/sandbox SWD-475` or `/implement SWD-475`.
