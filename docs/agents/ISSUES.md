...
|-----|------|-------|--------|--------|----------|------|
| SWD-542 | Task | [Tweak] Configurable NMPC max compute time on Controller Tuning | In Progress | — | docs/agents/PLAN-nmpc-max-compute.md | `/test SWD-542` — https://github.com/marcuskrogh/HeatingAssistant/pull/682 |
