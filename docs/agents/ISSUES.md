...
|-----|------|-------|--------|--------|----------|------|
| SWD-267 | Task | [Iterate] Ingress entity picker only shows App sensors — cannot wire HA room temperatures | In Progress | — | docs/agents/ITERATE.md | Implement wiring + PR |
