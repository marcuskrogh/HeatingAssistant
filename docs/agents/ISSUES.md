...
| SWD-440 | Story | [Adopt] Meet structure catalog on the production tree | In Progress | — | docs/agents/ADOPT.md | `/adopt` — walk unit chain; frontier SWD-445 |
...
| SWD-445 | Task | [Adopt] Split remaining Ingress panel god modules | In Progress | SWD-440 | docs/agents/ADOPT.md | `/implement SWD-445` — https://github.com/marcuskrogh/HeatingAssistant/pull/642 |
