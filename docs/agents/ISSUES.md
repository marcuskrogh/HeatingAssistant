...
|-----|------|-------|--------|--------|----------|------|
| SWD-298 | Bug | [Bug] Door/window sensors do not turn off heaters after configured debounce — App missing window override | In Review | — | docs/agents/PLAN-window-heater-override.md | `/review-fix SWD-298` — https://github.com/marcuskrogh/HeatingAssistant/pull/592 |
