...
|-----|------|-------|--------|--------|----------|------|
| SWD-275 | Task | [Iterate] MQTT rc=5 — SUPERVISOR_TOKEN missing without with-contenv entrypoint | In Review | — | docs/agents/ITERATE.md | In Review — https://github.com/marcuskrogh/HeatingAssistant/pull/564 |
