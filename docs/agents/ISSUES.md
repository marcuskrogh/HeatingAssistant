...
|-----|------|-------|--------|--------|----------|------|
| SWD-450 | Task | [Bug] Room plots missing optimal trajectories, price forecast, and outdoor temperature | In Progress | — | docs/agents/PLAN-2026-08-30-swd-450-catalog-forecast-attrs.md | `/test SWD-450` |
| SWD-451 | Sub-task | Preserve forecast attrs on catalog overlay + outdoor fallback | In Progress | SWD-450 | docs/agents/PLAN-2026-08-30-swd-450-catalog-forecast-attrs.md | — |
| SWD-452 | Sub-task | Tests, CalVer, changelog, App sync | In Progress | SWD-450 | docs/agents/PLAN-2026-08-30-swd-450-catalog-forecast-attrs.md | — |
...
## Log
- 2026-08-30 — `/implement` SWD-450 In Progress: catalog overlay preserves weather/price forecast attrs; skip non-numeric catalog states; outdoor °C falls back to weather `temperature` attr; CalVer 2026.08.35. Next `/test SWD-450`.
