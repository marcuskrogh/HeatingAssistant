...
|-----|------|-------|--------|--------|----------|------|
| SWD-264 | Task | [Iterate] Ingress UI 404 — static assets missing from pip install | In Progress | — | docs/agents/ITERATE.md | implement on `cursor/swd-264-ingress-static-01f0` |
