...
| SWD-440 | Story | [Adopt] Meet structure catalog on the production tree | In Progress | — | docs/agents/ADOPT.md | `/adopt` — walk unit chain; frontier SWD-444 |
...
| SWD-444 | Task | [Adopt] Split estimation, diagnostics, and PE HTTP god modules | In Progress | SWD-440 | docs/agents/ADOPT.md | `/implement SWD-444` |
