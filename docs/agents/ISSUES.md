...
|-----|------|-------|--------|--------|----------|------|
| SWD-288 | Bug | [Bug] Climate card setpoints reset to default — overview and room view cannot change target or comfort band | In Progress | — | docs/agents/BUG.md | Implement + PR; Next `/review-fix SWD-288` |
