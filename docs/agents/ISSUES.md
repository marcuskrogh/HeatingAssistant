...
|-----|------|-------|--------|--------|----------|------|
| SWD-564 | Task | [Bug] Wall temperature estimates leave the physical air–outdoor envelope | In Review | Relates SWD-554 | docs/agents/PLAN-wall-temp-reconstruction.md | `/ship SWD-564` — merge https://github.com/marcuskrogh/HeatingAssistant/pull/690 when CI is green |
