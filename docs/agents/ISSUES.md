...
|-----|------|-------|--------|--------|----------|------|
| SWD-421 | Task | [Iterate] Room view plots 15-minute steps instead of the 2-hour NMPC trajectory | In Review | — | docs/agents/ITERATE.md | `/review-fix SWD-421` — https://github.com/marcuskrogh/HeatingAssistant/pull/629 |
