...
|-----|------|-------|--------|--------|----------|------|
| SWD-421 | Task | [Iterate] Room view plots 15-minute steps instead of the 2-hour NMPC trajectory | In Progress | — | docs/agents/ITERATE.md | `/review-fix SWD-421` |
| SWD-422 | Sub-task | Keep Ingress plots on the installed 2-hour NMPC plan | In Progress | SWD-421 | docs/agents/ITERATE.md | — |
| SWD-423 | Sub-task | Tests, CalVer, changelog, App sync | In Progress | SWD-421 | docs/agents/ITERATE.md | — |
