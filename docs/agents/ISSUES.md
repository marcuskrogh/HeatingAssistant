...
|-----|------|-------|--------|--------|----------|------|
| SWD-276 | Task | [Iterate] KPIs/plots flat overnight — App has no wall-clock history/control ticker | In Review | — | docs/agents/ITERATE.md | In Review — https://github.com/marcuskrogh/HeatingAssistant/pull/565 |
