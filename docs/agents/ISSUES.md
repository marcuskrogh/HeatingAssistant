...
|-----|------|-------|--------|--------|----------|------|
| SWD-551 | Task | [Bug] Align room view plot vertical grids and NOW line | To Do | — | docs/agents/PLAN-room-view-plot-grid-alignment.md | `/architect SWD-551` — https://github.com/marcuskrogh/HeatingAssistant/pull/685 |
