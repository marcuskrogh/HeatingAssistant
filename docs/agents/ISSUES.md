...
| SWD-247 | Task | [Iterate] SWD-246: Ipopt install pass + SciPy NLP fallback; clean mode help | In Progress | SWD-238 | docs/agents/ITERATE-swd-247-ipopt-scipy-fallback.md | `/review-fix SWD-247` |
