...
|-----|------|-------|--------|--------|----------|------|
| SWD-408 | Task | [Tweak] Proper Heating Assistant icon for App and HA integration | To Do | — | docs/agents/PLAN-heating-assistant-icon.md | `/implement SWD-408` |
| SWD-409 | Sub-task | Brand mark SVG/PNGs + App and integration wiring | To Do | SWD-408 | docs/agents/PLAN-heating-assistant-icon.md | — |
| SWD-410 | Sub-task | Tests, CalVer, changelog, App sync | To Do | SWD-408 | docs/agents/PLAN-heating-assistant-icon.md | — |
