...
|-----|------|-------|--------|--------|----------|------|
| SWD-385 | Task | [Bug] System Status BAD tag quality despite fine HA sensor measurements | To Do | — | docs/agents/PLAN-tag-quality-stale-bad.md | `/implement SWD-385` |
| SWD-386 | Sub-task | Catalog overlay + prune persisted BAD tag quality | To Do | SWD-385 | docs/agents/PLAN-tag-quality-stale-bad.md | — |
| SWD-387 | Sub-task | Republish inbound tags when HA has started | To Do | SWD-385 | docs/agents/PLAN-tag-quality-stale-bad.md | — |
| SWD-388 | Sub-task | Tests, CalVer, App sync | To Do | SWD-385 | docs/agents/PLAN-tag-quality-stale-bad.md | — |
