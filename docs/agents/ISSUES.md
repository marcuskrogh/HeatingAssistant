...
|-----|------|-------|--------|--------|----------|------|
| SWD-475 | Task | [Sandbox] Animate KPI expand to top with viewport follow | To Do | — | docs/agents/SANDBOX-kpi-expand-motion.md | `/sandbox SWD-475` or `/implement SWD-475` |
