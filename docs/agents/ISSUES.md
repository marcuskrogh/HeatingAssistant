...
|-----|------|-------|--------|--------|----------|------|
| SWD-316 | Story | [Explore] Estimation history hole while plots + control OK | To Do | — | docs/ROADMAP.md | `/define SWD-317` |
...
| SWD-317 | Task | [Define] Surface ID history health on System Status | To Do | SWD-316 | docs/ROADMAP.md | `/define SWD-317` |
