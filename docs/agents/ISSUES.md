...
|-----|------|-------|--------|--------|----------|------|
| SWD-564 | Task | [Bug] Wall temperature estimates leave the physical air–outdoor envelope | In Progress | Relates SWD-554 | docs/agents/PLAN-wall-temp-reconstruction.md | `/test SWD-564` — https://github.com/marcuskrogh/HeatingAssistant/pull/690 |
