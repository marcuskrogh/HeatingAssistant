...
|-----|------|-------|--------|--------|----------|------|
| SWD-296 | Bug | [Bug] Sysid Apply Parameters not restored — defaults on reload + panel jumps to overview | In Progress | — | docs/agents/BUG.md | Implement complete — open PR / review-fix |
