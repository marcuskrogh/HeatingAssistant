...
|-----|------|-------|--------|--------|----------|------|
| SWD-400 | Task | [Iterate] NMPC must choose negative heater power when cooling is allowed | In Progress | — | docs/agents/ITERATE.md | `/implement SWD-400` |
| SWD-401 | Sub-task | Scale NMPC NLP so SLSQP can choose negative u | To Do | SWD-400 | docs/agents/ITERATE.md | — |
| SWD-402 | Sub-task | Tests, CalVer, App sync for signed NMPC u | To Do | SWD-400 | docs/agents/ITERATE.md | — |
