...
|-----|------|-------|--------|--------|----------|------|
| SWD-275 | Task | [Iterate] MQTT rc=5 — SUPERVISOR_TOKEN missing without with-contenv entrypoint | In Progress | — | docs/agents/ITERATE.md | In Progress — branch `cursor/swd-275-with-contenv-token-f56e` |
