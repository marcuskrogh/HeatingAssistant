...
|-----|------|-------|--------|--------|----------|------|
| SWD-269 | Task | [Iterate] Ingress features empty / Controller Tuning 502 after MQTT non-blocking start | In Review | — | docs/agents/ITERATE.md | `/review-fix SWD-269` — https://github.com/marcuskrogh/HeatingAssistant/pull/557 |
