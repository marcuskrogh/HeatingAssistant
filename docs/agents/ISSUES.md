...
|-----|------|-------|--------|--------|----------|------|
| SWD-281 | Task | [Iterate] App update clears room-plot / ID history — persist under /data like original integration | In Review | — | docs/agents/ITERATE.md | `/review-fix SWD-281` — https://github.com/marcuskrogh/HeatingAssistant/pull/572 |
