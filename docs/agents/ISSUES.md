...
| SWD-248 | Task | [Iterate] SWD-247: stop NMPC hang — executor, timeout, SciPy horizon gate | In Review | SWD-238 | docs/agents/ITERATE-swd-248-nmpc-hang-stability.md | `/review-fix SWD-248` |
