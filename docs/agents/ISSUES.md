...
|-----|------|-------|--------|--------|----------|------|
| SWD-296 | Bug | [Bug] Sysid Apply Parameters not restored — defaults on reload + panel jumps to overview | In Review | — | docs/agents/BUG.md | PR #588 — Next `/review-fix SWD-296` |
