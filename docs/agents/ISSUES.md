...
|-----|------|-------|--------|--------|----------|------|
| SWD-316 | Story | [Explore] Estimation history hole while plots + control OK | To Do | — | docs/ROADMAP.md | `/research SWD-319` |
| SWD-319 | Task | [Research] Discriminate id_history JSONL hole vs horizon load ignoring disk | To Do | SWD-316 | docs/ROADMAP.md | `/research SWD-319` |
| SWD-320 | Task | [Define] resolve_history(horizon) merges id_history JSONL | To Do | SWD-316 | docs/ROADMAP.md | `/define SWD-320` |
| SWD-318 | Task | [Define] Align ID sample write with plot cadence | To Do | SWD-316 | docs/ROADMAP.md | `/define SWD-318` (blocked by SWD-319) |
...
- 2026-08-11 — `/explore` SWD-316: estimation history hole while plots + control OK; route SWD-319/320/318/317; ROADMAP `docs/ROADMAP.md`; Next `/research SWD-319` (parallel `/define SWD-320`).
