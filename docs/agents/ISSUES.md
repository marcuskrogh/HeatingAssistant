...
|-----|------|-------|--------|--------|----------|------|
| SWD-465 | Task | [Bug] P-controller must track original NMPC trajectory for the 2 h window | To Do | — | docs/agents/PLAN-p-frozen-nmpc-tref.md | `/implement SWD-465` |
| SWD-466 | Sub-task | Keep P T_ref frozen at the last accepted NMPC plan | To Do | SWD-465 | docs/agents/PLAN-p-frozen-nmpc-tref.md | — |
| SWD-467 | Sub-task | Tests, CalVer, changelog, App sync for frozen P T_ref | To Do | SWD-465 | docs/agents/PLAN-p-frozen-nmpc-tref.md | — |
