...
| SWD-440 | Story | [Adopt] Meet structure catalog on the production tree | In Progress | — | docs/agents/ADOPT.md | `/adopt` — frontier SWD-445 In Review |
...
| SWD-445 | Task | [Adopt] Split remaining Ingress panel god modules | In Review | SWD-440 | docs/agents/ADOPT.md | `/review-fix SWD-445` — https://github.com/marcuskrogh/HeatingAssistant/pull/642 |
