...
|-----|------|-------|--------|--------|----------|------|
| SWD-385 | Task | [Bug] System Status BAD tag quality despite fine HA sensor measurements | In Review | — | docs/agents/PLAN-tag-quality-stale-bad.md | `/review-fix SWD-385` |
