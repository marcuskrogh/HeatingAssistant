...
|-----|------|-------|--------|--------|----------|------|
| SWD-321 | Task | [Tweak] Room DISTURBANCES outdoor/solar history as Measured-style points | In Review | — | docs/agents/PLAN-disturbances-history-points.md | `/review-fix SWD-321` — https://github.com/marcuskrogh/HeatingAssistant/pull/607 |
