...
|-----|------|-------|--------|--------|----------|------|
| SWD-288 | Bug | [Bug] Climate card setpoints reset to default — overview and room view cannot change target or comfort band | In Review | — | docs/agents/BUG.md | https://github.com/marcuskrogh/HeatingAssistant/pull/584 — Next `/review-fix SWD-288` |
