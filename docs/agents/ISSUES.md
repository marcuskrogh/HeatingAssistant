...
|-----|------|-------|--------|--------|----------|------|
| SWD-271 | Task | [Iterate] Streamline config UX — searchable HA entity picker + Environment recommendations | In Review | — | docs/agents/ITERATE.md | Done — https://github.com/marcuskrogh/HeatingAssistant/pull/559 |
