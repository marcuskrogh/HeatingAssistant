...
|-----|------|-------|--------|--------|----------|------|
| SWD-576 | Task | [Feature] Archive finished PE results below stored datasets | In Progress | Relates SWD-573 | docs/agents/PLAN-pe-fit-results.md | `/review SWD-576` — https://github.com/marcuskrogh/HeatingAssistant/pull/695 |
