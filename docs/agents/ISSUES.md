...
|-----|------|-------|--------|--------|----------|------|
| SWD-405 | Task | [Iterate] NMPC planned power stays at 0 kW when cooling is needed | In Review | — | docs/agents/ITERATE.md | Done — https://github.com/marcuskrogh/HeatingAssistant/pull/624 |
