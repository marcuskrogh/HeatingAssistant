...
|-----|------|-------|--------|--------|----------|------|
| SWD-536 | Task | [Iterate] Mode-general Next Compute and MPC Load KPIs | In Review | — | docs/agents/ITERATE-kpi-mpc-general.md | `/ship SWD-536` closeout — https://github.com/marcuskrogh/HeatingAssistant/pull/678 |
...
## Log
- 2026-09-09 — `/review-fix` SWD-536 CLEAN (focused): 0 blockers / 0 should-fix. pytest-fast leftover SWD-426/513 source locks updated. Next closeout merge PR #678.
