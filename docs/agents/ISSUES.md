...
|-----|------|-------|--------|--------|----------|------|
| SWD-516 | Task | [Tweak] Unique device+entity names on config sensor chips | To Do | — | docs/agents/PLAN-unique-config-sensor-labels.md | `/architect SWD-516` |
| SWD-517 | Sub-task | Unique display-name helper and catalog names | To Do | SWD-516 | docs/agents/PLAN-unique-config-sensor-labels.md | — |
| SWD-518 | Sub-task | Tests, CalVer, changelog, App sync for unique sensor labels | To Do | SWD-516 | docs/agents/PLAN-unique-config-sensor-labels.md | — |
...
## Log
- 2026-09-08 — `/define`+`/ship` SWD-516: unique device+entity names on config sensor chips. Next remaining chain on `swd-516-unique-config-sensor-labels`.
