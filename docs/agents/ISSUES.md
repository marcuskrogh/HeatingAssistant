...
|-----|------|-------|--------|--------|----------|------|
| SWD-297 | Bug | [Bug] Applied / measured solar gain stuck at 0 — App hass_states hardcodes solar_gain_measured | To Do | — | docs/agents/BUG.md | `/implement SWD-297` — https://github.com/marcuskrogh/HeatingAssistant/pull/590 |
