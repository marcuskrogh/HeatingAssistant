...
|-----|------|-------|--------|--------|----------|------|
| SWD-542 | Task | [Tweak] Configurable NMPC max compute time on Controller Tuning | In Review | — | docs/agents/PLAN-nmpc-max-compute.md | `/ship SWD-542` — https://github.com/marcuskrogh/HeatingAssistant/pull/682 |
