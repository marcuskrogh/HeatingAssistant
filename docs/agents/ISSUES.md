...
|-----|------|-------|--------|--------|----------|------|
| SWD-447 | Task | [Iterate] Ingress LOAD ERROR — extendDatasetToNow not found | In Review | — | docs/agents/ITERATE.md | `/ship SWD-447` — https://github.com/marcuskrogh/HeatingAssistant/pull/645 |
