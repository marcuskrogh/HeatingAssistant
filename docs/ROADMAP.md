...
- Guidance and a product PE procedure wait on this investigation.
...
| 4 | Synthesise household-like single-room traces and identify robust PE approaches | research | — | To Do | [SWD-328](https://marcusknielsen.atlassian.net/browse/SWD-328) |
...
## Next
`/research SWD-328` — synthesise household-like single-room traces and identify robust PE approaches.
