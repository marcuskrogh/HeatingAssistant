...
| 3 | Align ID sample write with plot cadence (durable-first append) | define | SWD-319 | To Do (PLAN ready) | [SWD-318](https://marcusknielsen.atlassian.net/browse/SWD-318) |
...
- SWD-318 define — Option B + durable-first; PLAN approved
...
`/implement SWD-318` — ID samples on ticker + update_tag + durable-first (fix-fast).
