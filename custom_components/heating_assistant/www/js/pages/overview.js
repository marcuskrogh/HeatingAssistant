...
import { createRoomClimateTile } from '../components/room-climate-tile.js?v=117';
import { createCountdown, updateCountdown } from '../components/countdown.js?v=117';
import { indexExperimentsByRoom } from '../experiment-utils.js?v=117';
import { mergeRoomSchedulesWithState } from '../schedules/schedules-shared.js?v=117';
import {
  KPI_SEVERITY,
