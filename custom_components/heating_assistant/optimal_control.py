...
MPC step.  The controller tracks per-room temperature setpoints with
configurable input and output constraints.
...
The soft output constraints keep room temperatures within
...
if TYPE_CHECKING:
    from .controller import LinearDiscreteModel
