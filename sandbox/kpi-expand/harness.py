#!/usr/bin/env python3
"""Serve the KPI-expand sandbox and capture stills with headless Chrome."""
...
class Handler(http.server.SimpleHTTPRequestHandler):
    def translate_path(self, path: str) -> str:
        ...
        if clean.startswith("/sandbox/kpi-expand/"):
            rel = clean[len("/sandbox/kpi-expand/") :].lstrip("/")
...
def _screenshot(url: str, dest: Path, width: int = 1280, height: int = 900) -> None:
