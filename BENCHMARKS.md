...
| Scenario               | Solver req | Solver active  |  mean (ms) | median (ms) | p95 (ms) |   n |
|------------------------|------------|----------------|------------|-------------|----------|-----|
| studio-1room           | IPOPT    | IPOPT          |    7115.8 |      7115.8 |   7115.8 |    1 |
| two-bedroom-2room      | IPOPT    | SLSQP          |   33055.5 |     33055.5 |  33055.5 |    1 |
| full-house-5room       | IPOPT    | IPOPT          |   13652.7 |     13652.7 |  13652.7 |    1 |
...
|-----------------------------|------------------------|------------|-----------------|-----------------|----------|
| KalmanMLEstimator.estimate  | studio-1room           | IPOPT    |      7037.6 |      7115.8 |      1.1% (slower) |
| KalmanMLEstimator.estimate  | two-bedroom-2room      | IPOPT    |     30681.3 |     33055.5 |      7.7% (slower) |
| KalmanMLEstimator.estimate  | full-house-5room       | IPOPT    |     11490.2 |     13652.7 |     18.8% (slower) |
