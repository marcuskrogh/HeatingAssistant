...
import { setScheduleEnabled, updateRoomSchedule } from '../ha-services.js?v=124';
import { getScheduleDataForRoom, patchStateSchedule, periodsMatch, resolveRoomScheduleData, CONFIG_ENTITY } from './schedules-shared.js?v=124';
import { renderExperimentsSection } from './schedules-experiments.js?v=124';
import {
  periodBodyHtml,
  periodHeaderHtml,
} from './schedules-detail-markup.js?v=143';
...
export function renderScheduleDetail(container, roomSlug, rooms, state, connection, hass) {
  ...
  function buildPeriodCard(i, p, { defaults, isActive, isNext }) {
    ...
    cardHeader.innerHTML = periodHeaderHtml({
      isActive,
      isNext,
      periodEnabled,
    ...
    cardBody.innerHTML = periodBodyHtml({
      scheduleType,
      whenByType,
      periodIndex: i,
      period: p,
